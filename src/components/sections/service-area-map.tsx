      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We proudly serve the greater Phoenix metropolitan area with
            professional landscaping services. From downtown Phoenix to the
            surrounding suburbs, we're your local landscaping experts.
          </p>
        </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="text-2xl font-bold text-blue-600">
                    {serviceAreas
                      .reduce((acc, area) => acc + area.projects, 0)
                      .toLocaleString()}
                    +
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      {selectedArea.projects.toLocaleString()}+
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We understand Phoenix's unique climate, soil conditions, and
                native plants.
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Thousands of satisfied customers across Phoenix and surrounding
                areas.
              </p>
            </div>
          </div>
